...
public class AbilitiesDTOTest {

    private AbilitiesDTO abilities;
    private AbilitiesDTO other;
    ...
    @Test
    public void createAbilitiesDTOWithId() {
    ...
    @Test
    public void abilitiesDTOIDDifferent() {
        other.setAbilitiesId (1L);
        assertFalse(abilities.equals(other));
    }
    ...
    public void hashCodeTestWithNull() {
        AbilitiesDTO abilities = new AbilitiesDTO(null, null, null, null, null, null, null);
        AbilitiesDTO other = new AbilitiesDTO(null, null, null, null, null, null, null);
