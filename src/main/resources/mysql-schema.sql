...
create table if not exists mesadnd.abilities(abilities_id int primary key NOT NULL auto_increment, skill_name varchar(30) NOT NULL, stat_modifier varchar(30) NOT NULL, full_proficiency tinyint(1) Not Null);
